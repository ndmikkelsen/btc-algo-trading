...
- [x] Update index.md, CLAUDE.md, VISION.md #p1
  > Add WORKFLOW.md to hierarchy in CLAUDE.md, reference section to .rules/index.md, and WORKFLOW link to VISION.md related documents.
- [x] Create libraries-reference.md #p1
  > Python libraries reference in .rules/reference/ organized by function: backtesting, data, TA, ML, stats, execution, risk, optimization, visualization.
- [x] Create strategies-catalog.md (10 categories) #p1
  > Comprehensive strategy catalog in .rules/reference/ with descriptions, BTC applicability ratings, implementation status, and references.
- [x] Create WORKFLOW.md (5-phase strategy pipeline) #p1
  > Top-level document defining Research > Backtest > Incubate > Deploy > Analyze pipeline with go/no-go gates for each phase.
- [x] Strategy Pipeline Foundation #p1
  > Foundational documents to systematize strategy research, evaluation, backtesting, and deployment. Includes WORKFLOW.md (5-phase pipeline), strategies catalog, and Python libraries reference. Creates the operating system for all future strategy development.
